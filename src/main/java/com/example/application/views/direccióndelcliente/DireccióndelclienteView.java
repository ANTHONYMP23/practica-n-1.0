package com.example.application.views.direccióndelcliente;
...
@PageTitle("Dirección del cliente . ")
@Route(value = "address-form", layout = MainLayout.class)
public class DireccióndelclienteView extends Div {
    ...
    public DireccióndelclienteView(SampleAddressService addressService) {
        addClassName("direccióndelcliente-view");
